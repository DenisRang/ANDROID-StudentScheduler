 ...
 */
public class MentorsCursorAdapter extends CursorAdapter {
     ...
     */
    public MentorsCursorAdapter(Context context, Cursor c) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int nameColumnIndex = cursor.getColumnIndex(EventContract.MentorEntry.COLUMN_NAME);
